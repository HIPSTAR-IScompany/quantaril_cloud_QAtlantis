---
title: 運用・移行
description: 原典、正本、生成、転送、URL互換、状態表示を管理する運用棚。
---

# 運用・移行

この棚は、何をどこから受け取り、どの棚へ移し、何を原典として残したかを追跡します。神話や技術の本文をここへ重複保存するのではなく、参照、状態、来歴、移行判断を管理します。

- [Q3からQ Atlantisへの移行](./migration/index.md)
